...
var DgraphClientStub = (function () {
    ...
    DgraphClientStub.prototype.query = function (req) {
        ...
        if (this.legacyApi) {
            ...
            if (req.startTs !== 0) {
                params.push({
                    key: "startTs",
                    value: "".concat(req.startTs),
                });
            }
            if (req.timeout > 0) {
                params.push({
                    key: "timeout",
                    value: "".concat(req.timeout, "s"),
                });
            }
            if (req.debug) {
                params.push({
    ...
    DgraphClientStub.prototype.mutate = function (mu) {
        ...
        if (mu.setJson !== undefined || mu.deleteJson !== undefined) {
            ...
            body = "{\n                ".concat(mu.setNquads === undefined
                ? ""
                : "set {\n                    ".concat(mu.setNquads, "\n                }"), "\n                ").concat(mu.deleteNquads === undefined
                ? ""
                : "delete {\n                    ".concat(mu.deleteNquads, "\n                }"), "\n            }");
        }
        ...
        var headers = __assign(__assign({}, (this.options.headers !== undefined ? this.options.headers : {})), { "Content-Type": "application/".concat(usingJSON ? "json" : "rdf") });
        ...
        if (((_a = mu === null || mu === void 0 ? void 0 : mu.hash) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            if (!this.legacyApi) {
                url += "".concat(nextDelim, "hash=").concat(mu.hash);
            }
        }
        if (mu.commitNow) {
            if (!this.legacyApi) {
                url += "".concat(nextDelim, "commitNow=true");
            }
            else {
                headers["X-Dgraph-CommitNow"] = "true";
            }
        }
        return this.callAPI(url, __assign(__assign({}, this.options), { method: "POST", body: body, headers: headers }));
    };
    DgraphClientStub.prototype.admin = function (req) {
        var headers = this.options.headers !== undefined
            ? __assign({}, this.options.headers) : {};
        headers["Content-Type"] = "application/graphql";
        return this.callAPI("admin", __assign(__assign({}, this.options), { method: "POST", body: req.mutation, headers: headers }));
    };
    DgraphClientStub.prototype.commit = function (ctx) {
        ...
        var url = !this.legacyApi
            ? "commit?startTs=".concat(ctx.start_ts)
            : "commit/".concat(ctx.start_ts);
        if (((_a = ctx === null || ctx === void 0 ? void 0 : ctx.hash) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            if (!this.legacyApi) {
                url += "&hash=".concat(ctx.hash);
            }
        }
    ...
    DgraphClientStub.prototype.abort = function (ctx) {
        var _a;
        var url = !this.legacyApi
            ? "commit?startTs=".concat(ctx.start_ts, "&abort=true")
            : "abort/".concat(ctx.start_ts);
        if (((_a = ctx === null || ctx === void 0 ? void 0 : ctx.hash) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            if (!this.legacyApi) {
                url += "&hash=".concat(ctx.hash);
            }
    ...
    DgraphClientStub.prototype.getHealth = function (all) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.callAPI("health".concat(all ? "?all" : ""), __assign(__assign({}, this.options), { acceptRawText: true }))];
            });
        });
    };
    ...
    DgraphClientStub.prototype.getURL = function (path) {
        return "".concat(this.addr).concat(this.addr.endsWith("/") ? "" : "/").concat(path);
    };
