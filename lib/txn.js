            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.dc.debug("Query response:\n".concat((0, util_1.stringifyMessage)(res)));
                        return [2, res];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.dc.debug("Mutate response:\n".concat((0, util_1.stringifyMessage)(ag)));
                        return [2, ag];
                    case 3:
                        e_1 = _a.sent();
                        _a.label = 4;
                    ...
                    case 6:
                        e_2 = _a.sent();
                        return [3, 7];
                    case 7: throw ((0, util_1.isAbortedError)(e_1) || (0, util_1.isConflictError)(e_1)) ? errors_1.ERR_ABORTED : e_1;
                    case 8: return [2];
                }
            });
        });
